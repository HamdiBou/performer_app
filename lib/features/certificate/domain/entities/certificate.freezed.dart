...
mixin _$Certificate {
 ...
 String get id; String get userId; String get conferenceId; String get issuedDate; String get filePath;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,conferenceId,issuedDate,filePath);

@override
String toString() {
  return 'Certificate(id: $id, userId: $userId, conferenceId: $conferenceId, issuedDate: $issuedDate, filePath: $filePath)';
}
...
@useResult
$Res call({
 String id, String userId, String conferenceId, String issuedDate, String filePath
});
...
/// Create a copy of Certificate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? conferenceId = null,Object? issuedDate = null,Object? filePath = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String conferenceId,  String issuedDate,  String filePath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Certificate() when $default != null:
return $default(_that.id,_that.userId,_that.conferenceId,_that.issuedDate,_that.filePath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String conferenceId,  String issuedDate,  String filePath)  $default,) {final _that = this;
switch (_that) {
case _Certificate():
return $default(_that.id,_that.userId,_that.conferenceId,_that.issuedDate,_that.filePath);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String conferenceId,  String issuedDate,  String filePath)?  $default,) {final _that = this;
switch (_that) {
case _Certificate() when $default != null:
return $default(_that.id,_that.userId,_that.conferenceId,_that.issuedDate,_that.filePath);case _:
  return null;
...
class _Certificate implements Certificate {
  const _Certificate({required this.id, required this.userId, required this.conferenceId, required this.issuedDate, required this.filePath});
...
/// Create a copy of Certificate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? conferenceId = null,Object? issuedDate = null,Object? filePath = null,}) {
