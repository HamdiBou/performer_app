...
import '../../../app/dialog/event_publish_dialog.dart';
...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  String dropdownvalue = 'Corporate';

  var items = ['Corporate', "Family", "Marraige"];
          ...
          child: ListView(
            ...
            children: [
              ...
              getDefaultTextFiledWithLabel(
                ...
                height: 60.h,
                withSufix: true,
                suffiximage: 'calender_black.svg',
                onTap: () async {
                    ...
                    child: getDefaultTextFiledWithLabel(
                      ...
                      onTap: () async {
                        ...
                        if (timeOfDay != null) {
                          ...
                          controller.onStartTimeChange(
                            format.format(startTime).obs,
                          );
                        }
                      },
                    ),
